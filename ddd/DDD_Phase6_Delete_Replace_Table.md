...
| 路径 | 建议 | 理由 |
|---|---|---|
| src/core/engine/AssetSystem.ts | 标记 legacy 或瘦身 | Node=Asset 已合并，AssetSystem 仅做投影 |
...
| src-tauri/src/infrastructure/database.rs | **保留** | SQLite 暂不退役 |
| src-tauri/src/features/project/persistence.rs | **保留** | SQLite 暂不退役 |
