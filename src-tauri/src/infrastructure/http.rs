...
//!
//! Provides HTTP request helpers for:
//! - Proxying requests to local services (CORS bypass)
//! - Fetching images as base64 data URIs
...
/// Response from fetching an image as base64.
