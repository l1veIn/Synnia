...
import { createImage, generateIcoBlob } from '@/lib/canvasUtils'
...
export function ImageExportDialog({ open, onOpenChange, src }: ImageExportDialogProps) {
  ...
  const handleGenerateAppIcons = async () => {
      ...
      try {
          ...
          // Favicon.ico (multiple sizes in one file) - not yet implemented for real multi-image ICO, just a single 16x16 PNG for now
          // For a proper multi-image ICO, a dedicated library is needed.
          // For now, let's just include a 16x16 png as favicon.ico
