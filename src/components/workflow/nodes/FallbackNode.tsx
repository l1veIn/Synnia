...
import { NodeHeader, NodeCollapseAction } from './primitives/NodeHeader';
    ...
    return (
        <NodeShell selected={selected} state="error" className="min-w-[150px]">
            ...
            <NodeHeader 
                ...
                title={data.title || "Unknown Type"} 
                actions={<NodeCollapseAction nodeId={id} isCollapsed={isCollapsed} />}
            />
            {!isCollapsed && (
