...
import { BaseNodeData, SynniaNode } from '@/presentation/types/project';
...
export interface ExecutionContext {
    ...
    engine: GraphEngine;
    node: SynniaNode;
    asset?: import('@/domain/asset/types').Asset;  // Asset for prompt customization
    manifest: RecipeManifest;
    chatContext?: import('@/domain/recipe/types').ChatMessage[];
    modelConfig?: import('@/domain/recipe/types').ModelConfig;
}
