...
import { useInspector } from '@/presentation/hooks/useInspector';
import { Button } from '@/presentation/components/ui/button';
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/presentation/components/ui/tabs';
import { Save, AlertCircle, FileText, Bot, MessageSquare, ScrollText } from 'lucide-react';
import { toast } from 'sonner';
import { cn } from '@/lib/utils';
import { AutoGenerateButton } from '@/presentation/components/ui/auto-generate-button';
import { FormRenderer } from '../../inspector/FormRenderer';
import type { RecipeAssetConfig, ModelConfig, RecipeExtra } from '@/domain/recipe/types';
...
export const RecipeNodeInspector = ({ assetId, nodeId }: RecipeNodeInspectorProps) => {
    ...
    const hasChatCapability = useMemo(() => {
        ...
        // Import at top: import { supportsChat } from '@/infrastructure/models/utils';
