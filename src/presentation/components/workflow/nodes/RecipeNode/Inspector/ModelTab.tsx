...
import { modelRegistry, ModelCategory, getAvailableProviders, getAvailableModels, type ModelPlugin } from '@/infrastructure/models';
import { useSettings } from '@/lib/settings';
import type { ModelConfig } from '@/domain/recipe/types';
import type { ModelCapability } from '@/infrastructure/models/types';
import { hasAllCapabilities } from '@/infrastructure/models/utils';
import { openSettingsDialog } from '@/presentation/components/settings/SettingsDialog';
