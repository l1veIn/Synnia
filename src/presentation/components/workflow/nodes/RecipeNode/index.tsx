...
import { SynniaNode, NodeType } from '@/presentation/types/project';
...
import { checkSchemaCompatibility } from '@/application/recipe/utils/schemaCompat';
import { portRegistry } from '@/presentation/engine/ports';
import { RecipeFormRenderer } from '@/presentation/components/workflow/widgets';
