...
import { SynniaNode, NodeType, BaseNodeData } from '@/presentation/types/project';
import { Asset } from '@/domain/asset/types';
import { deriveViewState, computeShellClassName, computeHeaderClassName } from '@/presentation/hooks/useNode';
